...
$sql_product = "SELECT p_id, p_name, inventory, price, img_path, s_id FROM product LIMIT $start_from, $num_per_page";
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href="addfavorite.php?p_id=<?= $row['p_id'] ?>">Add to Favorite</a></td>
                            <td><a href="addcart.php?p_id=<?= $row['p_id'] ?>">Add to Cart</a></td>
                        </tr>
                        <?php
                    }
                    ?>
